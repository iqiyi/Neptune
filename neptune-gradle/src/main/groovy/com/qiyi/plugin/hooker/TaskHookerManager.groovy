...
class TaskHookerManager {
    ...
    private void reWriteArscFile(ProcessAndroidResources par, ApkVariant variant) {
        ...
        String originalApplicationId = getOriginalApplicationId(par, variant)
        updateRJava(aapt, par.sourceOutputDir, originalApplicationId, resourceCollector)
    }
     ...
     *
     */
    def updateRJava(Aapt aapt, File sourceOutputDir, String originalApplicationId, ResourceCollector resourceCollector) {
